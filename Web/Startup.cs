    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var serviceConfiguration = new ServiceConfiguration(
                this.Configuration["Service:ServiceName"],
                this.Configuration["Service:BaseUrl"]);
            var apiGatewayConfiguration = new ServiceDiscoveryConfiguration(this.Configuration["ApiGatewayUrl"]);
